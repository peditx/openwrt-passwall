...
--Compatible with older versionsgeoDownload method configuration，Delete at the right time。
	...
	for k,v in ipairs(url) do
		if v ~= "geo2rule" then
			...
			if sret_tmp == 200 and non_file_check(download_file_tmp..k, vali_file..k) then
				log(rule_name.. " No." ..k.. "rules:" ..v.. "An error occurred while downloading the file，Try downloading again。")
