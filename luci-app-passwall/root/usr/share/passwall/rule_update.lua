...
if gfwlist_update == "1" then
	xpcall(fetch_gfwlist,function(e)
		log(e)
		log(debug.traceback())
		log('renewgfwlistAn error occurred...')
	end)
end
...
if chnroute_update == "1" then
	xpcall(fetch_chnroute,function(e)
		log(e)
		log(debug.traceback())
		log('renewchnrouteAn error occurred...')
	end)
end
...
if chnroute6_update == "1" then
	xpcall(fetch_chnroute6,function(e)
		log(e)
		log(debug.traceback())
		log('renewchnroute6An error occurred...')
	end)
end
...
if chnlist_update == "1" then
	xpcall(fetch_chnlist,function(e)
		log(e)
		log(debug.traceback())
		log('renewchnlistAn error occurred...')
	end)
end
...
if geoip_update == "1" then
	...
	xpcall(fetch_geoip,function(e)
		log(e)
		log(debug.traceback())
		log('renewgeoipAn error occurred...')
	end)
...
if geosite_update == "1" then
	...
	xpcall(fetch_geosite,function(e)
		log(e)
		log(debug.traceback())
		log('renewgeositeAn error occurred...')
	end)
