...
start_dns() {
	...
	[ -n "${UDP_PROXY_DNS}" ] && echolog "  * Please confirm upstream DNS support UDP Query and used UDP node，As upstream DNS Non-direct address，make sure UDP Agent opens，And it has been forwarded correctly！"
